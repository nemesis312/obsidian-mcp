---
id: 20260417-123617-53e8f5-spec
title: "Spec - Build a production-ready MCP server for Obsidian vaults in Go - zero-dependency single binary with 20 tools for knowledge graph operations (read, write, graph/links, tags, canvas)"
...
Use MCP tools to fill this in:

- get_template name=spec
- get_agent_instructions name=cpo
